...
MACRO_CONFIG_STR(SvName, sv_name, 128, "Last Day Server", CFGFLAG_SERVER, "Server name")
...
MACRO_CONFIG_STR(SvMap, sv_map, 128, "ld_jungle", CFGFLAG_SERVER, "Map to use on the server")
...
MACRO_CONFIG_STR(SvDefaultLanguage, sv_default_language, 32, "zh-cn", CFGFLAG_SERVER, "Default language")
