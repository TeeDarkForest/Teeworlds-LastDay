...
#include <game/server/lastday/lastday-config.h>
...
MACRO_CONFIG_INT(SvMaxClients, sv_max_clients, 512, 1, MAX_CLIENTS, CFGFLAG_SERVER, "Maximum number of clients that are allowed on a server")
...
MACRO_CONFIG_STR(SvDefaultLang, sv_default_lang, 16, "en", CFGFLAG_SERVER, "Server default language")
