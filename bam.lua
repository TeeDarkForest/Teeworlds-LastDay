...
function build(settings)
	...
	lastday = Compile(server_settings, Collect("src/lastday/*.cpp", "src/lastday/geolite/*.cpp"))
	...
	server_exe = Link(server_settings, "server", engine, server,
		game_shared, game_server, zlib, md5, server_link_other, lastday, json, teeuniverses)
